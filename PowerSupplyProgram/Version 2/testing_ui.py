...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        uic.loadUi(r"C:\Users\adekunlea\Documents\Programming\PowerSupplyProgram\Version 2\RPi_GUI_v1-1.ui", self)
        ...
        # Add Title
        self.graphWidget.setTitle(u"Power Supply Monitoring", color="k", size="12pt")
        # Add Axis Labels
