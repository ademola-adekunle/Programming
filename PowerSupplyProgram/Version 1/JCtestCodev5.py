...
if not os.path.exists("C:/Python27/PS Development/JC_Code/INI/psSettings.ini"):
   ...
   parser.set('Settings', 'ps1Current', '2.5')
   parser.set('Settings', 'ps2Current', '2.5')
   parser.set('Settings', 'userdefined_MaxPS1Voltage', '3.0')
   parser.set('Settings', 'userdefined_MaxPS2Voltage', '3.0')
   parser.set('Settings', 'userdefined_MaxPS1Current', '2.0')
   parser.set('Settings', 'userdefined_MaxPS2Current', '2.0')
...
userdefined_MaxPS1Current = float(parser.get("Settings", 'userdefined_MaxPS1Current'))
userdefined_MaxPS2Current = float(parser.get("Settings", 'userdefined_MaxPS2Voltage'))
