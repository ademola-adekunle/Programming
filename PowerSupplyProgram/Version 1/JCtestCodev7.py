...
if not os.path.exists("C:/Python2716/PS Development/JC_Code/INI/psSettings.ini"):
...
cfgfile = open("C:/Python2716/PS Development/JC_Code/INI/psSettings.ini",'r') #INI file creation. I would take this from the final code. This is just for the test
parser = SafeConfigParser()
parser.read("C:/Python2716/PS Development/JC_Code/INI/psSettings.ini")
...
class simpleapp_tk(Tkinter.Tk):
   def __init__(self, master):
      ...
      graph1displaylabel = Tkinter.Label(master,textvariable=self.graph1display,
                                        anchor="center",fg="white",bg="black") #putting a label behind the labels. Labels display text
      graph2displaylabel = Tkinter.Label(master,textvariable=self.graph2display,
                                        anchor="center",fg="white",bg="black") #putting a label behind the labels. Labels display text
      ...
      master.resizable(True,False) #a constraints allowing resizeable along horizontally(column)
